...
export function activate(context: vscode.ExtensionContext) {
  ...
  const ParameterDescriptions: {[key: string]: DESCRIPTION} = {
    ...
    'r': {
      ...
      description: ['Syntax: `r0`\\~`r65535`, `r?`',
        'SPC700 と DSP が使用するメインメモリを直接操作します。',
        '指定アドレスから 8bit 分読み書きできます。'],
      kind: vscode.CompletionItemKind.Field,
    },
    'rb': {
      title: ['64KB メインメモリ (8bit)', '64KB main memory (8-bit)'],
    ...
    'd': {
      ...
      description: ['Syntax: `d0`\\~, `d?`',
        'Script700 の実行のために用意された、巨大なデータ格納用メモリを参照します。',
        '指定アドレスから 8bit 分読み取れます。',
        '書き込みは可能ですが、非推奨です。'],
      kind: vscode.CompletionItemKind.Field,
    },
    'db': {
    ...
    'l': {
      ...
      description: ['Syntax: `l0`\\~`l1023`, `l?`',
        'Script700 のラベルがある場所を示すアドレスを取得します。',
        'Script700 データ領域の初期位置を取得する際に使用できます。'],
      kind: vscode.CompletionItemKind.Field,
    },
  };
  ...
  const LiteralDescriptions: {[key: string]: DESCRIPTION} = {
    ...
    'v': {
      ...
      description: ['Syntax: `0`\\~',
        '分母を 65536 とした分子の数で指定し、DSP の基準音量から乗算で変更します。',
        '`32768` で通常の半分、`131072` で通常の倍で出力されます。'],
      kind: vscode.CompletionItemKind.Field,
    },
  };
  ...
  const OperatorDescriptions: {[key: string]: DESCRIPTION} = {
    ...
    '/': {
      ...
      description: ['Syntax: `n <B> / <A>`',
        'Operation: `<B> = <B> / <A>`, like IDIV',
        '符号を考慮して `<B> ÷ <A>` を計算し、商を `<B>` に代入します。',
        '`<B>` は破壊的変更が行われます。'],
      kind: vscode.CompletionItemKind.Operator,
    },
    '\\': {
      ...
      description: ['Syntax: `n <A> \\ <B>`',
        'Operation: `<B> = <B> / <A>`, like DIV',
        '符号を考慮せずに `<B> ÷ <A>` を計算し、商を `<B>` に代入します。',
        '`<B>` は破壊的変更が行われます。'],
      kind: vscode.CompletionItemKind.Operator,
    },
    '%': {
    ...
    '$': {
      ...
      description: ['Syntax: `n <A> $ <B>`',
        'Operation: `<B> = <B> % <A>`, like DIV',
        '符号を考慮せずに `<B> ÷ <A>` を計算し、余りを `<B>` に代入します。',
        '`<B>` は破壊的変更が行われます。'],
      kind: vscode.CompletionItemKind.Operator,
    },
    '&': {
    ...
    '<': {
      ...
      description: ['Syntax: `n <A> < <B>`',
        'Operation: `<B> = <B> << <A>`, like SHL',
        '`<B>` の値を `<A>` の分だけ左にビットシフトを行い、結果を `<B>` に代入します。',
        '`<B>` は破壊的変更が行われます。'],
      kind: vscode.CompletionItemKind.Operator,
    },
    '_': {
      ...
      description: ['Syntax: `n <A> _ <B>`',
        'Operation: `<B> = <B> >> <A>`, like SAR',
        '符号を保持したまま `<B>` の値を `<A>` の分だけ右にビットシフトを行い、結果を `<B>` に代入します。',
        '`<B>` は破壊的変更が行われます。'],
      kind: vscode.CompletionItemKind.Operator,
    },
    '>': {
      ...
      description: ['Syntax: `n <A> > <B>`',
        'Operation: `<B> = <B> >> <A>`, like SHR',
        '符号を保持せずに `<B>` の値を `<A>` の分だけ右にビットシフトを行い、結果を `<B>` に代入します。',
        '`<B>` は破壊的変更が行われます。'],
      kind: vscode.CompletionItemKind.Operator,
    },
    '!': {
      ...
      description: ['Syntax: `n <A> ! <B>`',
        'Operation: `<B> = !<A>`, like `<B> = <A> ^ -1`',
        '`<A>` の否定値 (全ビットを排他的論理和で反転した結果) を `<B>` に代入します。',
        '`<B>` は破壊的変更が行われます。'],
      kind: vscode.CompletionItemKind.Operator,
    },
  };
  ...
  const FunctionDescriptions: {[key: string]: DESCRIPTION} = {
    ...
    'beq': {
      ...
      description: ['Syntax: `beq <LABEL>`',
        'Operation: `if (<C2> == <C1>) goto <LABEL>`',
        '直前の `c <C1> <C2>` コマンドで指定した `<C1>` と `<C2>` の値を比較します。',
        '`<C1>` と `<C2>` の値が一致する場合、指定したラベルの場所へジャンプします。'],
      kind: vscode.CompletionItemKind.Function,
    },
    'bne': {
      ...
      description: ['Syntax: `bne <LABEL>`',
        'Operation: `if (<C2> != <C1>) goto <LABEL>`',
        '直前の `c <C1> <C2>` コマンドで指定した `<C1>` と `<C2>` の値を比較します。',
        '`<C1>` と `<C2>` の値が一致しない場合、指定したラベルの場所へジャンプします。'],
      kind: vscode.CompletionItemKind.Function,
    },
    'bge': {
      title: ['ラベルへジャンプ (符号あり、以上)', 'Jump to label (signed, greater than or equals)'],
      description: ['Syntax: `bge <LABEL>`',
        'Operation: `if ((signed)<C2> >= <C1>) goto <LABEL>`',
        '直前の `c <C1> <C2>` コマンドで指定した `<C1>` と `<C2>` の値を比較します。',
        '符号を考慮して `<C2>` が `<C1>` 以上の場合、指定したラベルの場所へジャンプします。'],
      kind: vscode.CompletionItemKind.Function,
    },
    'ble': {
      ...
      description: ['Syntax: `ble <LABEL>`',
        'Operation: `if ((signed)<C2> <= <C1>) goto <LABEL>`',
        '直前の `c <C1> <C2>` コマンドで指定した `<C1>` と `<C2>` の値を比較します。',
        '符号を考慮して `<C2>` が `<C1>` 以下の場合、指定したラベルの場所へジャンプします。'],
      kind: vscode.CompletionItemKind.Function,
    },
    'bgt': {
      ...
      description: ['Syntax: `bgt <LABEL>`',
        'Operation: `if ((signed)<C2> > <C1>) goto <LABEL>`',
        '直前の `c <C1> <C2>` コマンドで指定した `<C1>` と `<C2>` の値を比較します。',
        '符号を考慮して `<C2>` が `<C1>` より大きい場合、指定したラベルの場所へジャンプします。'],
      kind: vscode.CompletionItemKind.Function,
    },
    'blt': {
      ...
      description: ['Syntax: `blt <LABEL>`',
        'Operation: `if ((signed)<C2> < <C1>) goto <LABEL>`',
        '直前の `c <C1> <C2>` コマンドで指定した `<C1>` と `<C2>` の値を比較します。',
        '符号を考慮して `<C2>` が `<C1>` より小さい場合、指定したラベルの場所へジャンプします。'],
      kind: vscode.CompletionItemKind.Function,
    },
    'bcc': {
      title: ['ラベルへジャンプ (符号なし、以上)', 'Jump to label (unsigned, greater than or equals)'],
      description: ['Syntax: `bcc <LABEL>`',
        'Operation: `if ((unsigned)<C2> >= <C1>) goto <LABEL>`',
        '直前の `c <C1> <C2>` コマンドで指定した `<C1>` と `<C2>` の値を比較します。',
        '符号を考慮せずに `<C2>` が `<C1>` 以上の場合、指定したラベルの場所へジャンプします。'],
      kind: vscode.CompletionItemKind.Function,
    },
    'blo': {
      ...
      description: ['Syntax: `blo <LABEL>`',
        'Operation: `if ((unsigned)<C2> <= <C1>) goto <LABEL>`',
        '直前の `c <C1> <C2>` コマンドで指定した `<C1>` と `<C2>` の値を比較します。',
        '符号を考慮せずに `<C2>` が `<C1>` 以下の場合、指定したラベルの場所へジャンプします。'],
      kind: vscode.CompletionItemKind.Function,
    },
    'bhi': {
      ...
      description: ['Syntax: `bhi <LABEL>`',
        'Operation: `if ((unsigned)<C2> > <C1>) goto <LABEL>`',
        '直前の `c <C1> <C2>` コマンドで指定した `<C1>` と `<C2>` の値を比較します。',
        '符号を考慮せずに `<C2>` が `<C1>` より大きい場合、指定したラベルの場所へジャンプします。'],
      kind: vscode.CompletionItemKind.Function,
    },
    'bcs': {
      ...
      description: ['Syntax: `bcs <LABEL>`',
        'Operation: `if ((unsigned)<C2> < <C1>) goto <LABEL>`',
        '直前の `c <C1> <C2>` コマンドで指定した `<C1>` と `<C2>` の値を比較します。',
        '符号を考慮せずに `<C2>` が `<C1>` より小さい場合、指定したラベルの場所へジャンプします。'],
      kind: vscode.CompletionItemKind.Function,
    },
    'r': {
      title: ['直前のジャンプに戻る', "Return to after `bxx` command", '@since 2.12.0'],
      description: ['Syntax: `r`',
        '最後に実行された `bxx` コマンドへジャンプして、その次のコマンドから再開します。',
        '`bxx` コマンドと組み合わせることで、サブルーチンを実装できます。'],
      kind: vscode.CompletionItemKind.Function,
    },
    'r1': {
    ...
    'f': {
      ...
      description: ['Syntax: `f`',
        'SPC700 入力ポートへの書き込みを `i1`->`i2`->`i3`->`i0` の順で行います。',
        '最後に、出力ポート `o0` と入力ポート `i0` が一致するまで待機します。',
        '実行後、`c <C1> <C2>` の `<C1>` に待機時間 (2,048kHz) が設定されます。',
        '`m #? <B>` で待機時間を `<B>` に代入することができます。'],
      kind: vscode.CompletionItemKind.Function,
    },
    'f1': {
      title: ['ポート書き込みを即時反映する', 'Resume SPC700 ports writing', '@since 2.17.2'],
      description: ['Syntax: `f1`',
        'SPC700 入力ポートへの書き込みを即時に行います。',
        '`f` コマンドを実行すると、自動的に `f1` コマンドが実行されます。'],
      kind: vscode.CompletionItemKind.Function,
    },
    'f0': {
      title: ['ポート書き込みを即時反映しない', 'Suspend SPC700 ports writing', '@since 2.17.2'],
      description: ['Syntax: `f0`',
        'SPC700 入力ポートへの書き込みを即時に行いません。',
        '`f` コマンドが実行されるまで、入力ポートへの書き込みは保留されます。'],
      kind: vscode.CompletionItemKind.Function,
    },
    'wi': {
    ...
    '#ib': {
      ...
      description: ['Syntax: `#ib "<FILE>"`', "`<FILE>` = Relative path",
        'ファイルをバイナリモードで読み込み、この場所に差し込みます。',
        'Script700 データ領域をバイナリで指定する際に使用できます。'],
      kind: vscode.CompletionItemKind.Interface,
    },
  };
  ...
  const DSPOptionDescriptions: {[key: string]: DESCRIPTION} = {
    ...
    'm': {
      ...
      description: ['Syntax: `m <SOUND>,!`', '`<SOUND>` = Tone number (0\\~255)',
        '指定した波形番号だけ音を消してミュート状態にします。',
        '同じ波形番号を再度指定すると、ミュートを解除します。'],
      kind: vscode.CompletionItemKind.Function,
    },
    'c': {
  ...
  const createCompletionWithComment = (document: vscode.TextDocument, lineIndex: number, label: string)
    ...
    return createCompletion(label, ParameterDescriptions['l'].title,
      escapeHTML(getComment(document, lineIndex)), vscode.CompletionItemKind.EnumMember);
  };
  ...
  const createMarkdown = (values: string[]): vscode.MarkdownString => {
    const markdown = new vscode.MarkdownString(values.map((value) => {
      if (value.startsWith('Syntax:')) {
        ...
        return `<span style="color:var(--vscode-charts-yellow);">${value}</span>`;
  ...
  const escapeHTML = (values: string[]): string[] => {
